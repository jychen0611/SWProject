...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_bbc_logo.setPixmap(QtGui.QPixmap('./src/BBC.png'))  # set while BBC logo
        self.label_bbc_logo.mousePressEvent = self.Clicked_label_bbc_logo
        self.label_bbc_red_bar.setPixmap(QtGui.QPixmap('./src/NEWS_Chinese.png'))   # set while BBC logo
        self.label_bbc_red_bar.mousePressEvent = self.Clicked_label_bbc_red_bar
        self.pushButton_go_back.clicked.connect(self.PushButton_go_back_on_clicked) # connect with clicked function
    ...
    ##### My Code #####
    def PushButton_go_back_on_clicked(self):
        print("承澤改這裡")
    ...
    def BuildNews(self):
        ...
        i=0
        for key, values in self.example.items():
            title = key
    ...
    def WebCrawer(self):
        ...
        self.example['肺炎疫情：分析中美背後的政治角力'] = ['https://ichef.bbci.co.uk/news/660/cpsprodpb/DBE1/production/_111398265_673d94a6-cb9b-4a33-a2a6-67940b35aff4.jpg', 'https://www.bbc.com/zhongwen/trad/world-52016078']
        self.example['英國王儲查爾斯王子確診感染新冠病毒 「症狀輕微」'] = ['https://ichef.bbci.co.uk/news/660/cpsprodpb/95E3/production/_111417383_5d7748e8-87bd-458a-baef-af40d207d905.jpg', 'https://www.bbc.com/zhongwen/trad/uk-52034402']
        self.example['肺炎疫情：無症狀感染者是否會導致第二次大爆發'] = ['https://ichef.bbci.co.uk/news/660/cpsprodpb/0E99/production/_110873730_p0831myp.jpg', 'https://www.bbc.com/zhongwen/trad/chinese-news-52016649']
        self.example['肺炎疫情：印度13億人口「宵禁」21天，全球最大規模封國面臨的挑戰'] = ['https://ichef.bbci.co.uk/news/660/cpsprodpb/F604/production/_111408926_gettyimages-1208075838.jpg', 'https://www.bbc.com/zhongwen/trad/world-52031681']
        self.example['肺炎疫情：特朗普冀復活節美國恢復正常'] = ['https://ichef.bbci.co.uk/news/660/cpsprodpb/5989/production/_111412922_hi060717157.jpg', 'https://www.bbc.com/zhongwen/trad/world-52032689']
        self.example['肺炎疫情：特朗普從堅稱「中國病毒」到表態「不是美國亞裔的錯」'] = ['https://ichef.bbci.co.uk/news/660/cpsprodpb/8D6D/production/_111050263_gettyimages-1205108047.jpg', 'https://www.bbc.com/zhongwen/trad/world-52027635']
        self.example['肺炎疫情：居家隔離如何鍛煉和保持最佳狀態'] = ['https://ichef.bbci.co.uk/news/660/cpsprodpb/BF8D/production/_111373094_070cb94f-a4b7-424c-8477-99259708e66d.jpg', 'https://www.bbc.com/zhongwen/trad/world-51977605']
